...
import './App.css'
import moviePlay from './assets/images/movie_play2.png'
import adultPlay from './assets/images/adult_play.png'
...
function App() {
  ...
  return (
    <>
      ...
      <p style={{marginTop: '120px'}}>18+ ya P*rn क्लिप देखने के लिए निचे वीडियो पे क्लिक करे </p>
